...
<section class="watch-video">
   ...
   <div class="video-details">
      <video src="./../images/upload_files/<?= $fetch_content['video']; ?>" class="video" poster="./../images/upload_files/<?= $fetch_content['thumb']; ?>" controls autoplay></video>
      ...
      <!-- <div class="tutor">
         <img src="./../../images/upload_files/<?= $fetch_tutor['image']; ?>" alt="">
         <div>
