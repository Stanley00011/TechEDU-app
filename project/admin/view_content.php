...
<section class="view-content">
   ...
   ?>
   <div class="container">
      <video src="./../../images/upload_files/<?= $fetch_content['video']; ?>" autoplay controls poster="../uploaded_files/<?= $fetch_content['thumb']; ?>" class="video"></video>
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <div class="box">
         <div class="user">
            <img src="./../../images/upload_files/<?= $fetch_commentor['image']; ?>" alt="">
            <div>
